...
mountShell('منصة تعليمية مرتبة', `<section class="hero"><div><span class="eyebrow">Minhaj 2.0</span><h2>كل ما تحتاجه للدراسة، مرتب في مكان واحد.</h2><p>فروع، مواد، مصادر، تأسيس، حلول، بطاقات واختبارات ومساعد ذكي. لأن الطالب لديه امتحان، وليس وقتًا لتفقد أثر 5000 ملف.</p><div class="actions"><a class="button primary" href="subjects.html">ابدأ من المواد</a><a class="button" href="tests.html">📝 الاختبارات</a><a class="button" href="account.html">👤 حساب الطالب</a><a class="button" href="ai.html">✦ مركز الذكاء</a></div></div><div class="hero-art">مِنهَاج<br><small>تعلم · راجع · أنجز</small></div></section><section><div class="section-head"><h2>الفروع</h2><a href="subjects.html">كل المواد</a></div><div id="homeBranches" class="grid"><div class="empty">جاري تحميل الفروع...</div></div></section><section class="feature-grid"><a class="feature card" href="resources.html"><b>📚 المصادر</b><span>بحث وفلترة مع pagination حقيقية.</span></a><a class="feature card" href="foundation.html"><b>🧠 التأسيس</b><span>ابدأ من المستوى المناسب لك.</span></a><a class="feature card" href="flashcards.html"><b>🗂️ البطاقات</b><span>مراجعة سريعة على الهاتف.</span></a><a class="feature card" href="tests.html"><b>📝 الاختبارات</b><span>اختبر فهمك بأسئلة متنوعة وراجع نتيجتك.</span></a><a class="feature card" href="solutions.html"><b>✅ الحلول</b><span>أسئلة وحلول مرتبة.</span></a><a class="feature card" href="account.html"><b>👤 حساب الطالب</b><span>تسجيل اختياري لفتح ميزات التخصيص وحفظ التجربة.</span></a></section>`);
