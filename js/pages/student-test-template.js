...
async function buildTemplate(){
  try{
    ...
    const data={
      ...
      showResults:true,
      questions:[
        {id:'q1',question:'نص السؤال',type:'mcq',options:['الخيار الأول','الخيار الثاني','الخيار الثالث'],answer:'الخيار الأول',explanation:'',points:1}
      ],
    ...
    root.innerHTML=`<div class="empty">تعذر تحميل UIDs للفروع والمواد. ${escapeHtml(e?.message||e?.code||'خطأ')}</div>`;
  }
}
