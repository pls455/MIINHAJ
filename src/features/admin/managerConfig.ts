...
export const ADMIN_ENTITIES: readonly AdminEntityDefinition[] = [
  ...
  { id: 'subjects', collection: 'subjects', label: 'المواد', permission: 'manageSubjects', fields: [{ key: 'name', label: 'اسم المادة', type: 'text', required: true }, { key: 'description', label: 'الوصف', type: 'textarea' }, { key: 'icon', label: 'الأيقونة', type: 'text' }, ...activeOrder] },
